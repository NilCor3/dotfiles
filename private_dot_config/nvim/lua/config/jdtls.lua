...
local function get_bundles()
  ...
  local java_debug_path = get_package_install_path 'java_debug'
  ...
  local java_test_path = get_package_install_path 'java_test'
  ...
  local settings = {
    java = {
      ...
      format = {
        ...
        settings = {
          url = vim.fn.stdpath 'config' .. '/lang_servers/java-code-style.xml',
